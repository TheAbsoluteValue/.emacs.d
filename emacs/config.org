...
#+BEGIN_SRC emacs-lisp
  (add-hook 'eshell-mode-hook (lambda () (linum-relative-global-mode nil)))
  (add-hook 'term-mode-hook (lambda () (linum-relative-global-mode nil)))
#+END_SRC
* Help
Packages and configs that help me learn Emacs
** Which-key
#+BEGIN_SRC emacs-lisp
